...
#  Description: Create a program that will return the Fibonacci base sequence of a given number 
...
#  Date Last Modified: 4/28/2016 


#Return a string that represents the number in Fibonacci base 
